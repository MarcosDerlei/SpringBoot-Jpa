package com.marcosderlei.aula.config;
...
import com.marcosderlei.aula.repositories.CategoryRepository;
import com.marcosderlei.aula.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2025-02-20T19:53:07Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2025-01-21T03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2025-01-22T15:21:22Z"), OrderStatus.WAITING_PAYMENT, u1);
